...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]:::[/COLOR] [COLOR white]BEM-VINDOS AO [COLOR white][B]ADDON[/COLOR] [COLOR red]AKATSUKI[/COLOR] [/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "AKASTSUKI 1.3\nESPERO QUE GOSTEM DOS NOSSOS CONTEUDOS, ENTRE EM CONTATO PARA PARTICIPAR DO NOSSO GRUPO"
####  LINK DO TITULO DE MENU  #########################################################
url_title = 'AGRADEÇO POR USAREM O ADDON AKATSUKI'

#### MENSAGEM BEM VINDOS  #############################################################
titulo_boas_vindas = "BEM-VINDOS"
mensagem_bem_vindo = "[B][COLOR white]AKATSUKI AGRADECE POR USAR NOSSO ADDON ![/COLOR]\n[COLOR red]Sejam bem vindos, espero que gostem do nosso addon, estamos atualizando com frenquência os contúdos:[/COLOR] [COLOR red]  -[/COLOR]  [/B]"
####  MENSAGEM SECUNDARIA ######################################################
...
thumb_icon_config = ''
desc_configuracoes = "Configurações da AKATUSKI"
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR white]AKATSUKI[/COLOR]  [COLOR gold](VIP)[/COLOR][/B]"
thumbnail_vip = ''
fanart_vip = ''
#### DESCRIÇÃO VIP ###########################################################
vip_descricao = 'SOLICITE SEU TESTE VIP E FAÇA SEU TESTE, O MENOR PREÇO DE TODOS'
#### DIALOGO VIP - SERVIDOR DESATIVADO - CLICK ###################################
vip_dialogo = "[B][COLOR white]CONFIGURE SEU ACESSO A NOSSA ÁREA VIP ANTES DE ENTRAR AQUI, MAIS INFORMAÇÕES ENTRE EM CONTATO COM NOSSO SUPORTE\nENTRE EM COMTATO PELO WHATSAPP: 55+ 71 996191556 [/COLOR][/B]"
##SERIVODR VIP
url_server_vip1 = ''
url_server_vip2 = ''
...
#Base
url_b64_principal = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0MwYUoycDRR'
...
def SKindex():
    ...
    if addon.getSetting('mensagem2') == 'true':
        ...
        xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%(__addonname__,getRequest2('https://pastebin.com/raw/2hUpkGna', 'https://pastebin.com/raw/dZn309pN'), time_msg, __icon__))
