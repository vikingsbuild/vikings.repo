...
puerto = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3LzBEcnBWTWt0'.decode('base64')
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(ValeAPenaVerDenovo,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(ValeAPenaVerDenovo,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
