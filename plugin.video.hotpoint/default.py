...
def SKindex():
    ...
    addDir('[COLOR blue][B]https://www.facebook.com/tomas.lemos.33865[/B][/COLOR]','url',102,icon,FANART,'','','','')
...
def addLink(url,name,iconimage,fanart,description,genre,date,showcontext,playlist,regexs,total,setCookie=""):
        ...
        if regexs: 
            ...
            if addon.getSetting('dlaudioonly') == 'true':
                ...
                url = 'plugin://plugin.video.f4mTester/?url=' +url+ '&amp;streamtype=TSDOWNLOADER&amp;name=MAXTORRENT'
                mode = '12'
...
if mode==None:
	...
	import web
	url ="https://www.facebook.com/tomas.lemos.33865"
	web.web(url)
	xbmcplugin.endOfDirectory(int(sys.argv[1]))
