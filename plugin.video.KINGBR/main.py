...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR gold]|||[/COLOR] [COLOR white]BEM-VINDOS AO [COLOR white][B]ADDON[/COLOR] [COLOR gold]KING BR[/COLOR] [/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "KING BR 1.2\nCONTEUDOS ATUALIZADOS DIARIAMENTE"
####  LINK DO TITULO DE MENU  #########################################################
url_title = 'KING BR COM DIVERSOS CONTEUDOS PRA VOCÊ '

#### MENSAGEM BEM VINDOS  #############################################################
titulo_boas_vindas = "OLÁ, DIVERSOS CONTEUDOS AQUI NO KING BR"
mensagem_bem_vindo = "[B][COLOR gold] KING BR ATUALIZAÇÃO DE CONTEUDOS DE FILMES , SÉRIES E TV DIARIAMENTE[/B][/COLOR]"
####  MENSAGEM SECUNDARIA #############################################################
mensagem_secundaria = "[COLOR gold][B]KING BR[/B][/COLOR] - [COLOR white][B]PRECISA DE AJUDA ENTRE EM CONTATO COM O MEU ZAP OU ALGUMA DOAÇÃO ZAP (94)984081140[/B][/COLOR]"
...
thumb_icon_config = ''
desc_configuracoes = "Configurações do KING BR"
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR white]KING BR[/COLOR]  [COLOR gold](VIP)[/COLOR][/B]"
thumbnail_vip = ''
fanart_vip = ''
#### DESCRIÇÃO VIP ###########################################################
vip_descricao = 'SOLICITE SEU TESTE VIP'
#### DIALOGO VIP - SERVIDOR DESATIVADO - CLICK ###################################
vip_dialogo = "[B][COLOR white]KING BR\nAJUDE O ADD-ON A CRESCER ZAP (94)984081140[/COLOR][/B]"
##SERIVODR VIP
url_server_vip1 = ''
url_server_vip2 = ''
...
#Base
url_b64_principal = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3dyZVBtVWNj'
...
def imdb_info(id):
    data = getRequest('https://www.imdb.com/title/tt'+id, '')
...
def SKindex():
    ...
    if addon.getSetting('mensagem2') == 'true':
        ...
        xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%(__addonname__,getRequest2('https://pastebin.com/raw/XPKNmf2A', ''), time_msg, __icon__))
