...
def main():
    main_url = "http://builds.kodiuk.tv/development/loki/main/main.xml"  #your main.xml url goes here
    sections = [
        {'name': 'loki', # can change jen to whatever you want.  This wil name the output xml jen.xml
         'url': "http://builds.kodiuk.tv/development/loki/main/main.xml", # your section xml goes here
         'poster': 'loki'}, # can change Jen to whatever you want. This will be displayed as the poster name on jen.xml and
                           # also in the actual search in your addon in kodi eg Jen - The Avengers
    ]

    os.remove("C:/Users/JONBOY/Desktop/python3/output/search.db")  # add the directory to where this file is stored
    dbcon = database.connect("C:/Users/JONBOY/Desktop/python3/output/search.db") # add the directory to where this file is stored
    dbcur = dbcon.cursor()
    dbcur.execute(
    ...
    for section in sections:
        ...
        file = open("C:/Users/JONBOY/Desktop/python3/output" + section['name'] + ".xml", "wb")
        xml = "<poster>%s</poster>\n" \
              "<cache>43200</cache>\n\n" % section['poster'] + xml
